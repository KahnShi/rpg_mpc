...
a[0] = ((real_t)(6.8000000000000005e-01)*(((real_t)(1.7000000000000001e-01)*u[1])-((real_t)(1.7000000000000001e-01)*u[3])));
a[1] = ((real_t)(1.2000000000000000e-02)*xd[12]);
a[2] = ((real_t)(7.0000000000000001e-03)*xd[11]);
a[3] = ((xd[11]*a[1])-(xd[12]*a[2]));
a[4] = ((real_t)(6.8000000000000005e-01)*(((real_t)(-1.7000000000000001e-01)*u[0])+((real_t)(1.7000000000000001e-01)*u[2])));
a[5] = ((real_t)(7.0000000000000001e-03)*xd[10]);
a[6] = ((xd[12]*a[5])-(xd[10]*a[1]));
a[7] = ((real_t)(6.8000000000000005e-01)*(((((real_t)(1.6000000000000000e-02)*u[0])-((real_t)(1.6000000000000000e-02)*u[1]))+((real_t)(1.6000000000000000e-02)*u[2]))-((real_t)(1.6000000000000000e-02)*u[3])));
a[8] = ((xd[10]*a[2])-(xd[11]*a[5]));
...
out[6] = ((real_t)(5.0000000000000000e-01)*(((xd[12]*xd[3])+(xd[11]*xd[4]))-(xd[10]*xd[5])));
out[7] = (((real_t)(2.0000000000000000e+00)*((xd[3]*xd[5])+(xd[4]*xd[6])))*(((u[0]+u[1])+u[2])+u[3]));
out[8] = (((real_t)(2.0000000000000000e+00)*((xd[5]*xd[6])-(xd[3]*xd[4])))*(((u[0]+u[1])+u[2])+u[3]));
out[9] = (((((real_t)(1.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[4])*xd[4]))-(((real_t)(2.0000000000000000e+00)*xd[5])*xd[5]))*(((u[0]+u[1])+u[2])+u[3]))-(real_t)(9.8065999999999995e+00));
out[10] = ((real_t)(1.4285714285714286e+02)*(a[0]-a[3]));
out[11] = ((real_t)(1.4285714285714286e+02)*(a[4]-a[6]));
out[12] = ((real_t)(8.3333333333333329e+01)*(a[7]-a[8]));
}
...
/* Compute intermediate quantities: */
a[0] = ((real_t)(1.2000000000000000e-02)*xd[12]);
a[1] = (real_t)(7.0000000000000001e-03);
a[2] = (a[0]-(xd[12]*a[1]));
a[3] = (real_t)(1.2000000000000000e-02);
a[4] = ((real_t)(7.0000000000000001e-03)*xd[11]);
a[5] = ((xd[11]*a[3])-a[4]);
a[6] = ((real_t)(1.1560000000000002e-01));
a[7] = ((real_t)(-1.1560000000000002e-01));
a[8] = (real_t)(7.0000000000000001e-03);
a[9] = ((xd[12]*a[8])-a[0]);
a[10] = ((real_t)(7.0000000000000001e-03)*xd[10]);
a[11] = (real_t)(1.2000000000000000e-02);
a[12] = (a[10]-(xd[10]*a[11]));
a[13] = ((real_t)(-1.1560000000000002e-01));
a[14] = ((real_t)(1.1560000000000002e-01));
a[15] = (real_t)(7.0000000000000001e-03);
a[16] = (a[4]-(xd[11]*a[15]));
a[17] = (real_t)(7.0000000000000001e-03);
a[18] = ((xd[10]*a[17])-a[10]);
a[19] = ((real_t)(1.0880000000000001e-02));
a[20] = ((real_t)(-1.0880000000000001e-02));
a[21] = ((real_t)(1.0880000000000001e-02));
a[22] = ((real_t)(-1.0880000000000001e-02));
...
out[107] = ((real_t)(5.0000000000000000e-01)*((real_t)(0.0000000000000000e+00)-xd[10]));
...
out[112] = ((real_t)(5.0000000000000000e-01)*((real_t)(0.0000000000000000e+00)-xd[5]));
out[113] = ((real_t)(5.0000000000000000e-01)*xd[4]);
out[114] = ((real_t)(5.0000000000000000e-01)*xd[3]);
...
out[122] = (((real_t)(2.0000000000000000e+00)*xd[5])*(((u[0]+u[1])+u[2])+u[3]));
out[123] = (((real_t)(2.0000000000000000e+00)*xd[6])*(((u[0]+u[1])+u[2])+u[3]));
out[124] = (((real_t)(2.0000000000000000e+00)*xd[3])*(((u[0]+u[1])+u[2])+u[3]));
out[125] = (((real_t)(2.0000000000000000e+00)*xd[4])*(((u[0]+u[1])+u[2])+u[3]));
...
out[133] = ((real_t)(2.0000000000000000e+00)*((xd[3]*xd[5])+(xd[4]*xd[6])));
out[134] = ((real_t)(2.0000000000000000e+00)*((xd[3]*xd[5])+(xd[4]*xd[6])));
out[135] = ((real_t)(2.0000000000000000e+00)*((xd[3]*xd[5])+(xd[4]*xd[6])));
out[136] = (real_t)(0.0000000000000000e+00);
out[137] = (real_t)(0.0000000000000000e+00);
out[138] = (real_t)(0.0000000000000000e+00);
out[139] = (((real_t)(2.0000000000000000e+00)*((real_t)(0.0000000000000000e+00)-xd[4]))*(((u[0]+u[1])+u[2])+u[3]));
out[140] = (((real_t)(2.0000000000000000e+00)*((real_t)(0.0000000000000000e+00)-xd[3]))*(((u[0]+u[1])+u[2])+u[3]));
out[141] = (((real_t)(2.0000000000000000e+00)*xd[6])*(((u[0]+u[1])+u[2])+u[3]));
out[142] = (((real_t)(2.0000000000000000e+00)*xd[5])*(((u[0]+u[1])+u[2])+u[3]));
...
out[150] = ((real_t)(2.0000000000000000e+00)*((xd[5]*xd[6])-(xd[3]*xd[4])));
out[151] = ((real_t)(2.0000000000000000e+00)*((xd[5]*xd[6])-(xd[3]*xd[4])));
out[152] = ((real_t)(2.0000000000000000e+00)*((xd[5]*xd[6])-(xd[3]*xd[4])));
...
out[157] = (((real_t)(0.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[4])+((real_t)(2.0000000000000000e+00)*xd[4])))*(((u[0]+u[1])+u[2])+u[3]));
out[158] = (((real_t)(0.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[5])+((real_t)(2.0000000000000000e+00)*xd[5])))*(((u[0]+u[1])+u[2])+u[3]));
...
out[167] = (((real_t)(1.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[4])*xd[4]))-(((real_t)(2.0000000000000000e+00)*xd[5])*xd[5]));
out[168] = (((real_t)(1.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[4])*xd[4]))-(((real_t)(2.0000000000000000e+00)*xd[5])*xd[5]));
out[169] = (((real_t)(1.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[4])*xd[4]))-(((real_t)(2.0000000000000000e+00)*xd[5])*xd[5]));
...
out[181] = ((real_t)(1.4285714285714286e+02)*((real_t)(0.0000000000000000e+00)-a[2]));
out[182] = ((real_t)(1.4285714285714286e+02)*((real_t)(0.0000000000000000e+00)-a[5]));
out[183] = (real_t)(0.0000000000000000e+00);
out[184] = ((real_t)(1.4285714285714286e+02)*a[6]);
out[185] = (real_t)(0.0000000000000000e+00);
out[186] = ((real_t)(1.4285714285714286e+02)*a[7]);
...
out[197] = ((real_t)(1.4285714285714286e+02)*((real_t)(0.0000000000000000e+00)-a[9]));
out[198] = (real_t)(0.0000000000000000e+00);
out[199] = ((real_t)(1.4285714285714286e+02)*((real_t)(0.0000000000000000e+00)-a[12]));
out[200] = ((real_t)(1.4285714285714286e+02)*a[13]);
out[201] = (real_t)(0.0000000000000000e+00);
out[202] = ((real_t)(1.4285714285714286e+02)*a[14]);
...
out[214] = ((real_t)(8.3333333333333329e+01)*((real_t)(0.0000000000000000e+00)-a[16]));
out[215] = ((real_t)(8.3333333333333329e+01)*((real_t)(0.0000000000000000e+00)-a[18]));
out[216] = (real_t)(0.0000000000000000e+00);
out[217] = ((real_t)(8.3333333333333329e+01)*a[19]);
out[218] = ((real_t)(8.3333333333333329e+01)*a[20]);
out[219] = ((real_t)(8.3333333333333329e+01)*a[21]);
out[220] = ((real_t)(8.3333333333333329e+01)*a[22]);
}
