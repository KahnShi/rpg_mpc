...
a[23] = (((od[2]*xd[10])+(od[4]*xd[11]))+(od[5]*xd[12]));
a[24] = (((od[1]*xd[10])+(od[3]*xd[11]))+(od[4]*xd[12]));
...
a[35] = (((od[0]*xd[10])+(od[1]*xd[11]))+(od[2]*xd[12]));
...
out[7] = ((((real_t)(2.0000000000000000e+00)*((xd[3]*xd[5])+(xd[4]*xd[6])))*(((u[0]+u[1])+u[2])+u[3]))/od[6]);
out[8] = ((((real_t)(2.0000000000000000e+00)*((xd[5]*xd[6])-(xd[3]*xd[4])))*(((u[0]+u[1])+u[2])+u[3]))/od[6]);
out[9] = ((((((real_t)(1.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[4])*xd[4]))-(((real_t)(2.0000000000000000e+00)*xd[5])*xd[5]))*(((u[0]+u[1])+u[2])+u[3]))/od[6])-(real_t)(9.8065999999999995e+00));
...
/* Compute intermediate quantities: */
a[0] = ((real_t)(1.0000000000000000e+00)/od[6]);
a[1] = ((real_t)(1.0000000000000000e+00)/od[6]);
a[2] = ((real_t)(1.0000000000000000e+00)/od[6]);
a[3] = ((real_t)(1.0000000000000000e+00)/od[6]);
a[4] = ((real_t)(1.0000000000000000e+00)/od[6]);
a[5] = ((real_t)(1.0000000000000000e+00)/od[6]);
...
a[36] = (a[35]/a[8]);
a[37] = (((od[2]*xd[10])+(od[4]*xd[11]))+(od[5]*xd[12]));
a[38] = ((xd[12]*od[0])-(a[37]+(xd[10]*od[2])));
...
a[46] = (a[45]/a[8]);
a[47] = (((od[1]*xd[10])+(od[3]*xd[11]))+(od[4]*xd[12]));
a[48] = ((a[47]+(xd[10]*od[1]))-(xd[11]*od[0]));
a[49] = ((a[37]+(xd[11]*od[4]))-(xd[12]*od[3]));
a[50] = ((xd[12]*od[1])-(xd[10]*od[4]));
a[51] = (((od[0]*xd[10])+(od[1]*xd[11]))+(od[2]*xd[12]));
a[52] = ((xd[10]*od[3])-(a[51]+(xd[11]*od[1])));
a[53] = ((xd[11]*od[5])-(a[47]+(xd[12]*od[4])));
a[54] = ((a[51]+(xd[12]*od[2]))-(xd[10]*od[5]));
a[55] = ((xd[10]*od[4])-(xd[11]*od[2]));
...
a[68] = (a[25]/a[16]);
a[69] = ((xd[11]*od[2])-(xd[12]*od[1]));
a[70] = (a[34]/a[16]);
a[71] = ((xd[12]*od[0])-(a[37]+(xd[10]*od[2])));
a[72] = (a[44]/a[16]);
a[73] = ((a[47]+(xd[10]*od[1]))-(xd[11]*od[0]));
a[74] = ((a[37]+(xd[11]*od[4]))-(xd[12]*od[3]));
a[75] = ((xd[12]*od[1])-(xd[10]*od[4]));
a[76] = ((xd[10]*od[3])-(a[51]+(xd[11]*od[1])));
a[77] = ((xd[11]*od[5])-(a[47]+(xd[12]*od[4])));
a[78] = ((a[51]+(xd[12]*od[2]))-(xd[10]*od[5]));
a[79] = ((xd[10]*od[4])-(xd[11]*od[2]));
...
a[92] = (a[17]/a[23]);
a[93] = ((xd[11]*od[2])-(xd[12]*od[1]));
a[94] = (a[32]/a[23]);
a[95] = ((xd[12]*od[0])-(a[37]+(xd[10]*od[2])));
a[96] = (a[42]/a[23]);
a[97] = ((a[47]+(xd[10]*od[1]))-(xd[11]*od[0]));
a[98] = ((a[37]+(xd[11]*od[4]))-(xd[12]*od[3]));
a[99] = ((xd[12]*od[1])-(xd[10]*od[4]));
a[100] = ((xd[10]*od[3])-(a[51]+(xd[11]*od[1])));
a[101] = ((xd[11]*od[5])-(a[47]+(xd[12]*od[4])));
a[102] = ((a[51]+(xd[12]*od[2]))-(xd[10]*od[5]));
a[103] = ((xd[10]*od[4])-(xd[11]*od[2]));
...
out[122] = ((((real_t)(2.0000000000000000e+00)*xd[5])*(((u[0]+u[1])+u[2])+u[3]))*a[0]);
out[123] = ((((real_t)(2.0000000000000000e+00)*xd[6])*(((u[0]+u[1])+u[2])+u[3]))*a[0]);
out[124] = ((((real_t)(2.0000000000000000e+00)*xd[3])*(((u[0]+u[1])+u[2])+u[3]))*a[0]);
out[125] = ((((real_t)(2.0000000000000000e+00)*xd[4])*(((u[0]+u[1])+u[2])+u[3]))*a[0]);
...
out[132] = (((real_t)(2.0000000000000000e+00)*((xd[3]*xd[5])+(xd[4]*xd[6])))*a[1]);
out[133] = (((real_t)(2.0000000000000000e+00)*((xd[3]*xd[5])+(xd[4]*xd[6])))*a[1]);
out[134] = (((real_t)(2.0000000000000000e+00)*((xd[3]*xd[5])+(xd[4]*xd[6])))*a[1]);
out[135] = (((real_t)(2.0000000000000000e+00)*((xd[3]*xd[5])+(xd[4]*xd[6])))*a[1]);
out[136] = (real_t)(0.0000000000000000e+00);
out[137] = (real_t)(0.0000000000000000e+00);
out[138] = (real_t)(0.0000000000000000e+00);
out[139] = ((((real_t)(2.0000000000000000e+00)*((real_t)(0.0000000000000000e+00)-xd[4]))*(((u[0]+u[1])+u[2])+u[3]))*a[2]);
out[140] = ((((real_t)(2.0000000000000000e+00)*((real_t)(0.0000000000000000e+00)-xd[3]))*(((u[0]+u[1])+u[2])+u[3]))*a[2]);
out[141] = ((((real_t)(2.0000000000000000e+00)*xd[6])*(((u[0]+u[1])+u[2])+u[3]))*a[2]);
out[142] = ((((real_t)(2.0000000000000000e+00)*xd[5])*(((u[0]+u[1])+u[2])+u[3]))*a[2]);
...
out[149] = (((real_t)(2.0000000000000000e+00)*((xd[5]*xd[6])-(xd[3]*xd[4])))*a[3]);
out[150] = (((real_t)(2.0000000000000000e+00)*((xd[5]*xd[6])-(xd[3]*xd[4])))*a[3]);
out[151] = (((real_t)(2.0000000000000000e+00)*((xd[5]*xd[6])-(xd[3]*xd[4])))*a[3]);
out[152] = (((real_t)(2.0000000000000000e+00)*((xd[5]*xd[6])-(xd[3]*xd[4])))*a[3]);
...
out[157] = ((((real_t)(0.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[4])+((real_t)(2.0000000000000000e+00)*xd[4])))*(((u[0]+u[1])+u[2])+u[3]))*a[4]);
out[158] = ((((real_t)(0.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[5])+((real_t)(2.0000000000000000e+00)*xd[5])))*(((u[0]+u[1])+u[2])+u[3]))*a[4]);
...
out[166] = ((((real_t)(1.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[4])*xd[4]))-(((real_t)(2.0000000000000000e+00)*xd[5])*xd[5]))*a[5]);
out[167] = ((((real_t)(1.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[4])*xd[4]))-(((real_t)(2.0000000000000000e+00)*xd[5])*xd[5]))*a[5]);
out[168] = ((((real_t)(1.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[4])*xd[4]))-(((real_t)(2.0000000000000000e+00)*xd[5])*xd[5]))*a[5]);
out[169] = ((((real_t)(1.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[4])*xd[4]))-(((real_t)(2.0000000000000000e+00)*xd[5])*xd[5]))*a[5]);
